Public Class VentEntretenimiento
    ...
    Private Sub conexion()
        ...
        If tipodb = "\conexionA.udl" Then 'si access esta seleccionado ejecute este query
            sql = "SELECT TOP 1 * FROM PRENGUNTAS where id_tema = 4 and id_pregunta = " & num.Next(78, 93 + 1) 'selecciona una pregunta al azar
        Else
            sql = "SELECT TOP 1 * FROM PRENGUNTAS where id_tema = 4 ORDER BY NEWID()"      'trae un pregunta al azar(TEMA 4 = entretenimiento)
        End If
