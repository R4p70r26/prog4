Public Class VentGeografia
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles BtnOpcion1.Click
    ...
    Private Sub conexion()
        ...
        If tipodb = "\conexionA.udl" Then 'si access esta seleccionado ejecute este query
            sql = "SELECT TOP 1 * FROM PRENGUNTAS where id_tema = 5 and id_pregunta = " & num.Next(94, 107 + 1) 'selecciona una pregunta al azar
        Else
            sql = "SELECT TOP 1 * FROM PRENGUNTAS where id_tema = 5 ORDER BY NEWID()"      'trae un pregunta al azar(TEMA 5 = geografia)
        End If
    ...
    Private Sub VentGeografia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        conexion()
        Timer1.Enabled = True
    ...
    Private Sub TiempoPregunta() 'cambio de jugador si se acaba el tiempo
        ...
        If tiempo = 0 Then
            ...
            Me.Close()
            MuestraNombresJugadores.Show() 'llama ruleta
